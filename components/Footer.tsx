export default function Footer() {
  ...
  return (
    <footer className="mt-12 text-white relative overflow-hidden footer-root">
      ...
      <div className="relative max-w-6xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 sm:grid-cols-3 items-center gap-6 text-sm" style={{ direction: "ltr" }}>
          ...
          <div className="text-right sm:text-left" style={{ direction: "rtl" }}>
            <p className="text-base font-black tracking-wide" style={{ color: "var(--yellow)" }}>مسندم نت</p>
